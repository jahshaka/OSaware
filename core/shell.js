        ...
        if (topic === 'FILES' || topic === 'VFS' || topic === 'DIR') {
            ...
            lines = [
                ...
                '  - Window title is set to OSAWARE — PROGRAMNAME.',
                   ...
                   topic === 'AITEMP' || topic === 'AITOKENS' || topic === 'AIKEY' || topic === 'AICLEAR') {
            lines = [
                'AI <prompt> [, RESULT$]',
                ...
                '',
                'AISYSTEM "text"   /   AISYSTEM VAR$   /   AISYSTEM',
                '  Set the system prompt — your persona / raw context /',
                '  data the model should always know. Replaces the',
                '  built-in default. AISYSTEM "" resets it; AISYSTEM',
                '  with no argument prints the current one.',
                '',
                ...
                'AICLEAR ALL       also reset AISYSTEM/AIMODEL/AITEMP/AITOKENS',
                '',
            ...
            lines = [
                ...
                '  AI:       AI, AINUM, AISYSTEM, AIMODEL, AITEMP/AITOKENS, AIKEY, AICLEAR  (HELP AI)',
                '',
                'VIRTUAL FILE SYSTEM',
