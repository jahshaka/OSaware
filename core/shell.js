...
// VFSDEL "path" — delete a user VFS asset.
    ...
    // yield pattern — same shape as cmdAIRUN. Sync commands (DEVWHOAMI,
    // WHOAMI, production stubs) just print and return.
    // =======================================================================
...
// only the line numbers present in the file.
    ...
    help(topic) {
        ...
        if (topic === 'FILES' || topic === 'VFS' || topic === 'DIR') {
            ...
            lines = [
                'AI <prompt> [, RESULT$]',
                '  Send a prompt to Claude AI and stream the reply',
                '  into the terminal. If RESULT$ is given, the response',
                '  is stored silently in that variable instead.',
                '',
                'AINUM <prompt>, VAR',
                '  Send a prompt and store the numeric response in VAR.',
                '  Useful for calculations or scored responses.',
                '',
                'AIKEY',
                '  Enter your Anthropic API key securely (masked input).',
                '  Key is stored in memory for this session only.',
                '',
                'AICLEAR',
                ...
                '    10 AI "Name a planet", P$',
                '    20 PRINT "The AI chose: "; P$',
                '',
                '  Numeric response:',
            ...
            lines = [
                ...
                '  GL.INSTANCE id,x,y,z,ryDeg,pitchDeg,lenScale',
                '    Add one GPU instance of mesh id: its local +X axis is pitched',
                '    up pitchDeg, yawed ryDeg about Y, then scaled lenScale on X.',
            ...
            lines = [
                ...
                '  AI:       AI [,R$], AINUM, AIKEY, AICLEAR  (HELP AI)',
                '',
                'VIRTUAL FILE SYSTEM',
